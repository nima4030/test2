...
class _OfflinePageState extends State<OfflinePage> {
  ...
  int maxChances = 6;
  int dicBookIndex = 0;
  var dicBook = [["All", "Full wordlist", "A", Colors.indigo],['Computer Sience','Computer Sience wordlist','C',Colors.tealAccent],
                ["Chemistry", "Chemistry wordlist", "C", Colors.deepOrangeAccent],["Biology", "Biology wordlist", "B", Colors.amber],
